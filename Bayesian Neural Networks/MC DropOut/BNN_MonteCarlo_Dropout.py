...
# Edited by Valyo Yolovski( https://github.com/valyome/Neural-Networks-with-MC-Dropout )
# Edited by Dilip Rajkumar
...
#         y_train_normalized = np.array(y_train_normalized, ndmin = 2).T
    ...
    def predict(self, X_test, y_test):
        ...
        """
            ...
            @return v       The predictive variance for the test target variables.

            @return s       The predictive Std. Deviation for the test target variables.
