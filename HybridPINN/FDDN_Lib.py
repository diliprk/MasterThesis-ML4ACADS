...
with open('C:/Users/dilip/Desktop/FDDN/MSN235_TZ6_FDDN7/MSN235_TZ6_FDDN0out.fddn','r') as f:
...
#     print('Output Column Names:\n',cols_order)
    ...
    for i in range(len(zeta_list)):
        ...
        with open('LTR_Vhat.fddn', 'w') as f: # Save out FDDN json file containing input values to the FDDN Solver
            f.write(json.dumps(json_data,indent=2))
        Popen("run_fddn.bat", cwd=r"D:\My Git\MasterThesis-ML4ACADS\HybridPINN", stdout=None, stderr = None).communicate() # Run FDDN Solver
        # Read Saved results from the FDDN Solver - Update filename in 'run_fddn.bat'
        fddn_results_df = pd.read_csv('LTR_Vhat.result_HYBRD1',delimiter=';',header=[0,1])
